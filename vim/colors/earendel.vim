...
if &background == "light"
    hi Normal ctermbg=15 ctermfg=0 guibg=bg guifg=#000000 gui=none
    ...
    " Added 13 jun 2012
    hi LineNr		guifg=gray			guibg=white			gui=none
    ...
    hi TabLineFill	guifg=gray		guibg=darkgray			gui=none
    hi TabLineFill	ctermfg=gray	ctermbg=darkgray		cterm=none
    hi TabLineSel		guifg=white		guibg=darkgray			gui=none
    ...
    hi Comment ctermbg=7 ctermfg=darkgray guibg=#eeeeee guifg=#558817 gui=none
